...
function getLanguage() {
  return localStorage.getItem('language') || 'en'; // Default to 'en' (English)
}
...
function applyLanguage() {
  ...
  if (selectedLang) {
    Cookies.set("googtrans", `/en/${selectedLang}`, { path: "" });
    Cookies.set("googtrans", `/en/${selectedLang}`, { path: "", domain: location.host });
...
$(document).ready(function () {
  applyLanguage(); // Call on page load to apply language preference
});
...
$(document).ready(function () {
  // Your existing code for initializing the language selector
  ...
  if (langSelector) {
    langSelector.addEventListener("change", function () {
      ...
      applyLanguage(); // Optionally reload page or immediately apply the language change
    });
  }
});
...
// Add this to manage the language persistence
function setLanguage(lang) {
  localStorage.setItem('language', lang);
  let url = new URL(window.location);
  url.searchParams.set("lang", lang);
